var app = (function() {
    ...
    function createPhongMaterial(material) {
        ...
        material.ka = material.ka || [ 0.4, 0.3, 0.8 ];
    ...
    function initModels() {
        ...
        var mTorus = createPhongMaterial({ka: [0.122,0.094,0.157], kd: [0.7, 0.03, 0.03]});
        createModel("torus", fs, [ 1, 1, 1, 1 ], [ 0, .75, 0 ],
                [ 0, 0, 0, 0 ], [ 1, 1, 1, 1 ], mTorus);

        var mSphere1 = createPhongMaterial({ka: [0.122,0.094,0.157], kd: [0.0, 0.7, 0.0]});
        createModel("sphere", fs, [ 1, 1, 1, 1 ], [ -1.25, .5, 0 ], [ 0, 0,
                0, 0 ], [ .5, .5, .5 ], mSphere1);

        var mSphere2 = createPhongMaterial({ka: [0.122,0.094,0.157], kd: [0.03, 0.03, 0.6]});
        createModel("sphere", fs, [ 1, 1, 1, 1 ], [ 1.25, .5, 0 ], [ 0, 0,
                0, 0 ], [ .5, .5, .5 ], mSphere2);

        var mPlane = createPhongMaterial({ka:[0.122,0.094,0.157], kd:[.5,.5,.5],           
            ks:[0.,0.,0.], ke:-1.});
